              ...
              {loading ? (
                ...
                reports.slice(0, 4).map((report) => (
                  <button 
                    ...
                    className="w-full flex items-center justify-between p-3.5 border border-[#f0efea] rounded-2xl hover:bg-[#fafbf9] transition-all group text-left cursor-pointer"
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-[10px] font-bold bg-[#faf9f5] border border-[#ecebe6] text-slate-600 px-3 py-1 rounded-full">
                        {report.processingStatus === "processing" ? "Analyzing..." : report.processingStatus === "failed" ? "Failed" : "Report"}
                      </span>
